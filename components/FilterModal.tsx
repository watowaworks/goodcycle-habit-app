...
export default function FilterModal({
  ...
  return (
    ...
    >
      ...
      >
        <h1 className="text-2xl font-bold mb-6 text-center">フィルター設定</h1>
        ...
        <div className="flex gap-4">
          <button
            type="button"
            onClick={onClose}
            className="w-full py-2 rounded-lg font-semibold transition bg-gray-300 text-gray-700 hover:bg-gray-400"
          >
            キャンセル
          </button>
          <button
            type="button"
            onClick={handleApply}
            className="w-full py-2 rounded-lg font-semibold transition bg-blue-500 text-white hover:bg-blue-600"
          >
            決定
          </button>
        </div>
